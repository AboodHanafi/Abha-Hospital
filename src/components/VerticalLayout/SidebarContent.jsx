            ...
            <ul className="metismenu list-unstyled" id="side-menu">
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <Link to="#">{this.props.t("Product Details")}</Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="#">{this.props.t("Add Product")}</Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    ...
                    <ul className="sub-menu" aria-expanded="false">
                      <li>
                        <Link to="#">{this.props.t("Basic Action")}</Link>
                      </li>
                      <li>
                        <Link to="#">{this.props.t("Alert Email")} </Link>
                      </li>
                      <li>
                        <Link to="#">{this.props.t("Billing Email")} </Link>
                      </li>
                    </ul>
                  </li>
                </ul>
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  <li>
                    <Link to="#">{this.props.t("Invoice List")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Invoice Detail")}</Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul className="sub-menu">
                  <li>
                    <Link to="#">{this.props.t("Job List")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Job Grid")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Apply Job")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Job Details")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Jobs Categories")}</Link>
                  </li>
                  <li>
                    <Link to="/#" className="has-arrow">
                      {this.props.t("Candidate")}
                    </Link>
                    <ul className="sub-menu" aria-expanded="true">
                      <li>
                        <Link to="#">{this.props.t("List")}</Link>
                      </li>
                      <li>
                        <Link to="#">{this.props.t("Overview")}</Link>
                      </li>
                    </ul>
                  </li>
                </ul>
              ...
              <li>
                ...
                <ul className="sub-menu">
                  ...
                  <li>
                    <Link to="#">{this.props.t("Register 2")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Recover Password")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Recover Password 2")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Lock Screen")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Lock Screen 2")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Confirm Mail")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Confirm Mail 2")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Email Verification")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Email Verification 2")}</Link>
                  </li>
                  <li>
                    <Link to="#">{this.props.t("Two Step Verification")}</Link>
                  </li>
                  <li>
                    <Link to="#">
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <Link to="#">{this.props.t("Drag & Drop Table")}</Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul className="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <Link to="#">{this.props.t("Jquery Knob Chart")}</Link>
                  </li>
                  <li>
